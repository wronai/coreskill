        ...
        try:
            ...
            if not matched:
                return {
                    ...
                    'spoken': 'Nie rozpoznałem zapytania o pogodę w Gdańsku'
                }
            ...
            if weather_data['temperature']:
                spoken_text = f"Pogoda w Gdańsku: {weather_data['temperature']} stopni, {weather_data['condition']}"
                return {
                    'success': True,
            ...
            if instant_answer_match:
                ...
                spoken_text = f"Pogoda w Gdańsku: {temp} stopni, {condition}"
                return {
                    'success': True,
                    'location': 'Gdańsk',
            ...
            return {
                ...
                'spoken': 'Nie udało się znaleźć aktualnej pogody w Gdańsku'
            }
            ...
            return {
                ...
                'spoken': 'Błąd połączenia z internetem'
            }
        except Exception as e:
            return {
                'success': False,
                ...
                'spoken': 'Wystąpił nieoczekiwany błąd podczas pobierania pogody'
            }
...
if __name__ == '__main__':
    ...
    assert 'spoken' in result, "Missing 'spoken' key"
