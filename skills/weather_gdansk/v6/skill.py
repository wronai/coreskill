...
def health_check() -> dict:
    try:
        # Test network connectivity by making a minimal request
...
def execute(params: dict) -> dict:
    try:
        ...
        if not parser.temp:
            return {
                "success": False,
                "message": "Could not extract weather data for Gdańsk"
            }
...
if __name__ == "__main__":
    ...
    result = execute_wrapper(test_params)
    print(result)