...
class CurrencyConverterGBPtoJPY:
    def execute(self, params: dict) -> dict:
        try:
            ...
            # Map Polish words for numbers to actual numbers
            number_words = {
                'tysiąc': 1000,
                'tysiące': 1000,
                'tysięcy': 1000,
            ...
            # Default to 1000 if still no amount found (as per requirement)
            if amount is None:
                amount = 1000
            ...
            if not (has_gbp and has_jpy):
                ...
                if 'funty' in text and 'jeny' in text:
                    has_gbp = True
                    has_jpy = True
                else:
                    return {
            ...
            try:
                ...
                gbp_to_jpy_rate = 185.0  # Approximate rate as fallback
