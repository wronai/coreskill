...
class Kalkulator:
    def execute(self, params: dict) -> dict:
        ...
        try:
            ...
            # Domyślnie eval() ma dostęp do wielu wbudowanych funkcji, co może być ryzykowne.
            # Tutaj ograniczamy się do podstawowych operacji matematycznych.
            # Można by rozważyć użycie biblioteki ast.literal_eval, ale ona nie obsługuje operacji.
