...
class Kalkulator:
    def execute(self, params: dict) -> dict:
        ...
        try:
            ...
            # Usunięto niepotrzebne słowa kluczowe z regex, które mogłyby kolidować z liczbami.
            ...
            try:
                ...
                return {'success': False, 'error': f'Błąd parsowania wyrażenia: {str(e)}'}
...
if __name__ == '__main__':
    ...
    test_cases = [
        ...
        {'text': '10 */ 5'}, # Dwa operatory
        {'text': '10 /* 5'}, # Dwa operatory
        {'text': '10 */* 5'}, # Trzy operatory
        {'text': '10 + ( )'}, # Puste nawiasy
        {'text': '10 + ()'}, # Puste nawiasy
        {'text': '10 + (5 + )'}, # Nieprawidłowe nawiasy
        {'text': '10 + )5 + 2('}, # Nieprawidłowe nawias