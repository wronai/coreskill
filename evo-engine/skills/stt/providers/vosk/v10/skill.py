...
This code fixes the NameError for 'shutil' and uses standard library functions instead of shutil.which(). It also follows your requirements for the class structure and execute() method return format.